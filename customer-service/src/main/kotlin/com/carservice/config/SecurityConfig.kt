...
class SecurityConfig(
    ...
    fun filterChain(http: HttpSecurity): SecurityFilterChain {
        http
            ...
            .oauth2ResourceServer { oauth2 ->
                oauth2.jwt { jwt ->
                    // JWK Set URI and issuer are auto-configured from application.yml
    ...
    fun jwtAuthenticationConverter(): JwtAuthenticationConverter {
        ...
        converter.setJwtGrantedAuthoritiesConverter { jwt ->
            jwtUserDetailsMapper.createUserDetailsFromJwt(jwt).authorities
        }
        return converter
    }
    ...
    fun isEmployee(authentication: Authentication): Boolean {
        ...
        return roles.any { it in listOf("MECHANIC", "CAR_DETAILER", "CAR_PAINTER", "ELECTRICIAN", "ADMIN") }
    }
}